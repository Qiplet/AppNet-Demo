...
#define RESOURCE_URL @"AppNetDemo"
#define STORE_URL @"NetAppDemo.sqlite"
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:STORE_URL];
